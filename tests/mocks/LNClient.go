...
// GenerateOfferSync provides a mock function for the type MockLNClient
func (_mock *MockLNClient) GenerateOfferSync(ctx context.Context, description string) (string, error) {
...
func (_c *MockLNClient_GenerateOfferSync_Call) Return(s string, err error) *MockLNClient_GenerateOfferSync_Call {
	_c.Call.Return(s, err)
	return _c
}

func (_c *MockLNClient_GenerateOfferSync_Call) RunAndReturn(run func(ctx context.Context, description string) (string, error)) *MockLNClient_GenerateOfferSync_Call {
	_c.Call.Return(run)
	return _c
}
