        ...
        <div className="w-full max-w-lg">
          <form onSubmit={onSubmit} className="flex flex-col gap-4">
            <div className="flex items-center text-center text-foreground font-medium rounded-lg bg-muted p-1">
              <div className="cursor-not-allowed rounded-md flex-1 py-1.5 text-sm">
                Swap In
              </div>
              <div className="cursor-pointer rounded-md flex-1 py-1.5 text-sm bg-white">
                Swap Out
              </div>
            </div>
              ...
              <>
                <div className="flex items-top space-x-2">
                  ...
                  <div className="grid gap-1.5 leading-none">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Enable if you want Alby Hub to automatically swap funds
            ...
            <LoadingButton loading={loading}>
              {recurringSwaps ? "Enable Auto Swaps" : "Swap Out"}
            </LoadingButton>
          </form>
        </div>
