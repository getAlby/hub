                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent className="w-[400px]">
                            ...
                            Value4Value payments you will need a public channel.
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent className="w-[400px]">
                            ...
                            the channel capacity. The reserve will automatically
                            be filled when payments are received on the channel.
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
