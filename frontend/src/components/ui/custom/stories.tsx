...
export function StoryItem({
    ...
    return (
        ...
        >
            <div
                className={cn(
                    "rounded-full flex items-center justify-center cursor-pointer p-0.5",
                    story.seen
                        ? "bg-muted" // Seen state
                        : "border-primary border-2 duration-1000" // Unseen state with animated primary color border
                )}
                onClick={handleClick}
            >
