  ...
  transformIndexHtml: {
    ...
    handler: (html) => {
      return html.replace(
        ...
        <meta http-equiv="Content-Security-Policy" content="default-src 'self' ${DEVELOPMENT_NONCE}; style-src 'self' 'unsafe-inline'; img-src 'self' https://uploads.getalby-assets.com https://getalby.com; connect-src 'self' https://api.getalby.com https://getalby.com https://zapplanner.albylabs.com wss://relay.getalby.com/v1; frame-src https://embed.bitrefill.com" />`
      );
    },
  },
};
