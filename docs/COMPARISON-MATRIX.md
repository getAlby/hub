...
| Keysend | keysend RPC | LDK custom-preimage keysend works | **incoming** via pump (TLVs dropped); **outgoing NIP-47 fixed** (accept+ignore preimage) | ✅ after fix; ⚠️ TLV loss documented |
