...
echo "Alby Hub listens on port 8029 on all network interfaces, e.g. http://<server-ip>:8029"
echo "⚠️  Alby Hub is intended for secure local networks. Make sure port 8029 is not reachable from the public internet (use a firewall or VPN)."
