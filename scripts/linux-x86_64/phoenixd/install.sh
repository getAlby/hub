...
echo ""
echo "✅ DONE."
echo "Alby Hub listens on port 8080 on all network interfaces, e.g. http://<server-ip>:8080"
echo "⚠️  Alby Hub is intended for secure local networks. Make sure port 8080 is not reachable from the public internet (use a firewall or VPN)."
