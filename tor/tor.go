...
func (s *Service) Start(cfg *Config) error {
	...
	// If a new key was generated by Tor (shouldn't happen since we provide one),
	// save it for future reference
	if resp.Key != nil && key == nil {
		logger.Logger.Warn("Tor generated a new key unexpectedly")
	}
...
func loadOrCreateKey(dataDir string) (control.Key, error) {
	...
	onionAddr := encodeOnionV3(pubKey)
	if onionAddr != "" {
