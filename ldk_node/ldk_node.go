...
func (cb RustBuffer) Free() {
	rustCall(func(status *C.RustCallStatus) bool {
		C.ffi_ldk_node_bindings_rustbuffer_free(cb, status)
		return false
	})
}
...
func bytesToRustBuffer(b []byte) RustBuffer {
	...
	return rustCall(func(status *C.RustCallStatus) RustBuffer {
		return C.ffi_ldk_node_bindings_rustbuffer_from_bytes(foreign, status)
	})
}
...
func uniffiCheckChecksums() {
	...
	scaffoldingContractVersion := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint32_t {
		return C.ffi_ldk_node_bindings_uniffi_contract_version(uniffiStatus)
	})
	...
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_func_default_config(uniffiStatus)
		})
		if checksum != 23889 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_func_default_config: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_func_generate_entropy_mnemonic(uniffiStatus)
		})
		if checksum != 39445 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_func_generate_entropy_mnemonic: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_builder_build(uniffiStatus)
		})
		if checksum != 46772 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_builder_build: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_builder_set_entropy_bip39_mnemonic(uniffiStatus)
		})
		if checksum != 26562 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_builder_set_entropy_bip39_mnemonic: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_builder_set_entropy_seed_bytes(uniffiStatus)
		})
		if checksum != 65137 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_builder_set_entropy_seed_bytes: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_builder_set_entropy_seed_path(uniffiStatus)
		})
		if checksum != 19618 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_builder_set_entropy_seed_path: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_builder_set_esplora_server(uniffiStatus)
		})
		if checksum != 33174 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_builder_set_esplora_server: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_builder_set_gossip_source_p2p(uniffiStatus)
		})
		if checksum != 63798 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_builder_set_gossip_source_p2p: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_builder_set_gossip_source_rgs(uniffiStatus)
		})
		if checksum != 14522 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_builder_set_gossip_source_rgs: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_builder_set_listening_addresses(uniffiStatus)
		})
		if checksum != 46417 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_builder_set_listening_addresses: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_builder_set_network(uniffiStatus)
		})
		if checksum != 62695 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_builder_set_network: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_builder_set_storage_dir_path(uniffiStatus)
		})
		if checksum != 4473 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_builder_set_storage_dir_path: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_channelconfig_accept_underpaying_htlcs(uniffiStatus)
		})
		if checksum != 15854 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_channelconfig_accept_underpaying_htlcs: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_channelconfig_cltv_expiry_delta(uniffiStatus)
		})
		if checksum != 30876 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_channelconfig_cltv_expiry_delta: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_channelconfig_force_close_avoidance_max_fee_satoshis(uniffiStatus)
		})
		if checksum != 19430 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_channelconfig_force_close_avoidance_max_fee_satoshis: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_channelconfig_forwarding_fee_base_msat(uniffiStatus)
		})
		if checksum != 43022 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_channelconfig_forwarding_fee_base_msat: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_channelconfig_forwarding_fee_proportional_millionths(uniffiStatus)
		})
		if checksum != 58911 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_channelconfig_forwarding_fee_proportional_millionths: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_channelconfig_set_accept_underpaying_htlcs(uniffiStatus)
		})
		if checksum != 240 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_channelconfig_set_accept_underpaying_htlcs: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_channelconfig_set_cltv_expiry_delta(uniffiStatus)
		})
		if checksum != 22579 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_channelconfig_set_cltv_expiry_delta: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_channelconfig_set_force_close_avoidance_max_fee_satoshis(uniffiStatus)
		})
		if checksum != 58010 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_channelconfig_set_force_close_avoidance_max_fee_satoshis: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_channelconfig_set_forwarding_fee_base_msat(uniffiStatus)
		})
		if checksum != 1601 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_channelconfig_set_forwarding_fee_base_msat: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_channelconfig_set_forwarding_fee_proportional_millionths(uniffiStatus)
		})
		if checksum != 3853 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_channelconfig_set_forwarding_fee_proportional_millionths: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_channelconfig_set_max_dust_htlc_exposure_from_fee_rate_multiplier(uniffiStatus)
		})
		if checksum != 56939 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_channelconfig_set_max_dust_htlc_exposure_from_fee_rate_multiplier: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_channelconfig_set_max_dust_htlc_exposure_from_fixed_limit(uniffiStatus)
		})
		if checksum != 48786 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_channelconfig_set_max_dust_htlc_exposure_from_fixed_limit: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_close_channel(uniffiStatus)
		})
		if checksum != 48466 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_close_channel: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_connect(uniffiStatus)
		})
		if checksum != 19059 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_connect: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_connect_open_channel(uniffiStatus)
		})
		if checksum != 50243 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_connect_open_channel: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_disconnect(uniffiStatus)
		})
		if checksum != 64295 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_disconnect: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_event_handled(uniffiStatus)
		})
		if checksum != 49153 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_event_handled: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_is_running(uniffiStatus)
		})
		if checksum != 25893 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_is_running: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_list_channels(uniffiStatus)
		})
		if checksum != 54619 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_list_channels: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_list_payments(uniffiStatus)
		})
		if checksum != 46740 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_list_payments: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_list_peers(uniffiStatus)
		})
		if checksum != 15889 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_list_peers: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_listening_addresses(uniffiStatus)
		})
		if checksum != 11414 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_listening_addresses: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_new_onchain_address(uniffiStatus)
		})
		if checksum != 35051 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_new_onchain_address: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_next_event(uniffiStatus)
		})
		if checksum != 56674 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_next_event: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_node_id(uniffiStatus)
		})
		if checksum != 46505 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_node_id: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_payment(uniffiStatus)
		})
		if checksum != 25193 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_payment: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_receive_payment(uniffiStatus)
		})
		if checksum != 48050 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_receive_payment: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_receive_variable_amount_payment(uniffiStatus)
		})
		if checksum != 31256 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_receive_variable_amount_payment: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_remove_payment(uniffiStatus)
		})
		if checksum != 13103 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_remove_payment: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_send_all_to_onchain_address(uniffiStatus)
		})
		if checksum != 25749 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_send_all_to_onchain_address: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_send_payment(uniffiStatus)
		})
		if checksum != 45316 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_send_payment: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_send_payment_probes(uniffiStatus)
		})
		if checksum != 5035 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_send_payment_probes: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_send_payment_probes_using_amount(uniffiStatus)
		})
		if checksum != 14124 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_send_payment_probes_using_amount: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_send_payment_using_amount(uniffiStatus)
		})
		if checksum != 14196 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_send_payment_using_amount: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_send_spontaneous_payment(uniffiStatus)
		})
		if checksum != 48603 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_send_spontaneous_payment: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_send_spontaneous_payment_probes(uniffiStatus)
		})
		if checksum != 4703 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_send_spontaneous_payment_probes: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_send_to_onchain_address(uniffiStatus)
		})
		if checksum != 48368 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_send_to_onchain_address: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_sign_message(uniffiStatus)
		})
		if checksum != 36472 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_sign_message: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_spendable_onchain_balance_sats(uniffiStatus)
		})
		if checksum != 37794 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_spendable_onchain_balance_sats: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_start(uniffiStatus)
		})
		if checksum != 57463 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_start: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_stop(uniffiStatus)
		})
		if checksum != 38777 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_stop: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_sync_wallets(uniffiStatus)
		})
		if checksum != 8177 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_sync_wallets: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_total_onchain_balance_sats(uniffiStatus)
		})
		if checksum != 64092 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_total_onchain_balance_sats: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_update_channel_config(uniffiStatus)
		})
		if checksum != 17496 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_update_channel_config: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_verify_signature(uniffiStatus)
		})
		if checksum != 27369 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_verify_signature: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_method_ldknode_wait_next_event(uniffiStatus)
		})
		if checksum != 25955 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_method_ldknode_wait_next_event: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_constructor_builder_from_config(uniffiStatus)
		})
		if checksum != 37363 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_constructor_builder_from_config: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_constructor_builder_new(uniffiStatus)
		})
		if checksum != 18265 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_constructor_builder_new: UniFFI API checksum mismatch")
		}
	}
	{
		checksum := rustCall(func(uniffiStatus *C.RustCallStatus) C.uint16_t {
			return C.uniffi_ldk_node_bindings_checksum_constructor_channelconfig_new(uniffiStatus)
		})
		if checksum != 11086 {
			// If this happens try cleaning and rebuilding your project
			panic("ldk_node: uniffi_ldk_node_bindings_checksum_constructor_channelconfig_new: UniFFI API checksum mismatch")
		}
	}
}
...
func NewBuilder() *Builder {
	return FfiConverterBuilderINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.uniffi_ldk_node_bindings_fn_constructor_builder_new(_uniffiStatus)
	}))
}

func BuilderFromConfig(config Config) *Builder {
	return FfiConverterBuilderINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.uniffi_ldk_node_bindings_fn_constructor_builder_from_config(FfiConverterTypeConfigINSTANCE.Lower(config), _uniffiStatus)
	}))
}
...
func (_self *Builder) Build() (*LdkNode, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeBuildError{}, func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.uniffi_ldk_node_bindings_fn_method_builder_build(
...
func (_self *Builder) SetEntropyBip39Mnemonic(mnemonic Mnemonic, passphrase *string) {
	...
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_builder_set_entropy_bip39_mnemonic(
...
func (_self *Builder) SetEntropySeedBytes(seedBytes []uint8) error {
	...
	_, _uniffiErr := rustCallWithError(FfiConverterTypeBuildError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_builder_set_entropy_seed_bytes(
...
func (_self *Builder) SetEntropySeedPath(seedPath string) {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_builder_set_entropy_seed_path(
...
func (_self *Builder) SetEsploraServer(esploraServerUrl string) {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_builder_set_esplora_server(
...
func (_self *Builder) SetGossipSourceP2p() {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_builder_set_gossip_source_p2p(
			_pointer, _uniffiStatus)
		return false
	})
}
...
func (_self *Builder) SetGossipSourceRgs(rgsServerUrl string) {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_builder_set_gossip_source_rgs(
...
func (_self *Builder) SetListeningAddresses(listeningAddresses []SocketAddress) error {
	...
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError(FfiConverterTypeBuildError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_builder_set_listening_addresses(
...
func (_self *Builder) SetNetwork(network Network) {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_builder_set_network(
...
func (_self *Builder) SetStorageDirPath(storageDirPath string) {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_builder_set_storage_dir_path(
	...
	result := &Builder{
		newFfiObject(
			...
			func(pointer unsafe.Pointer, status *C.RustCallStatus) {
				C.uniffi_ldk_node_bindings_fn_free_builder(pointer, status)
			}),
	}
...
func NewChannelConfig() *ChannelConfig {
	return FfiConverterChannelConfigINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) unsafe.Pointer {
		return C.uniffi_ldk_node_bindings_fn_constructor_channelconfig_new(_uniffiStatus)
	}))
}
...
func (_self *ChannelConfig) AcceptUnderpayingHtlcs() bool {
	...
	return FfiConverterBoolINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.int8_t {
		return C.uniffi_ldk_node_bindings_fn_method_channelconfig_accept_underpaying_htlcs(
			_pointer, _uniffiStatus)
	}))
}
...
func (_self *ChannelConfig) CltvExpiryDelta() uint16 {
	...
	return FfiConverterUint16INSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint16_t {
		return C.uniffi_ldk_node_bindings_fn_method_channelconfig_cltv_expiry_delta(
			_pointer, _uniffiStatus)
	}))
}
...
func (_self *ChannelConfig) ForceCloseAvoidanceMaxFeeSatoshis() uint64 {
	...
	return FfiConverterUint64INSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint64_t {
		return C.uniffi_ldk_node_bindings_fn_method_channelconfig_force_close_avoidance_max_fee_satoshis(
			_pointer, _uniffiStatus)
	}))
}
...
func (_self *ChannelConfig) ForwardingFeeBaseMsat() uint32 {
	...
	return FfiConverterUint32INSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint32_t {
		return C.uniffi_ldk_node_bindings_fn_method_channelconfig_forwarding_fee_base_msat(
			_pointer, _uniffiStatus)
	}))
}
...
func (_self *ChannelConfig) ForwardingFeeProportionalMillionths() uint32 {
	...
	defer _self.ffiObject.decrementPointer()
	return FfiConverterUint32INSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.uint32_t {
		return C.uniffi_ldk_node_bindings_fn_method_channelconfig_forwarding_fee_proportional_millionths(
			_pointer, _uniffiStatus)
	}))
}
...
func (_self *ChannelConfig) SetAcceptUnderpayingHtlcs(value bool) {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_channelconfig_set_accept_underpaying_htlcs(
...
func (_self *ChannelConfig) SetCltvExpiryDelta(value uint16) {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_channelconfig_set_cltv_expiry_delta(
...
func (_self *ChannelConfig) SetForceCloseAvoidanceMaxFeeSatoshis(valueSat uint64) {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_channelconfig_set_force_close_avoidance_max_fee_satoshis(
...
func (_self *ChannelConfig) SetForwardingFeeBaseMsat(feeMsat uint32) {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_channelconfig_set_forwarding_fee_base_msat(
...
func (_self *ChannelConfig) SetForwardingFeeProportionalMillionths(value uint32) {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_channelconfig_set_forwarding_fee_proportional_millionths(
...
func (_self *ChannelConfig) SetMaxDustHtlcExposureFromFeeRateMultiplier(multiplier uint64) {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_channelconfig_set_max_dust_htlc_exposure_from_fee_rate_multiplier(
...
func (_self *ChannelConfig) SetMaxDustHtlcExposureFromFixedLimit(limitMsat uint64) {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_channelconfig_set_max_dust_htlc_exposure_from_fixed_limit(
...
func (c FfiConverterChannelConfig) Lift(pointer unsafe.Pointer) *ChannelConfig {
	result := &ChannelConfig{
		newFfiObject(
			pointer,
			func(pointer unsafe.Pointer, status *C.RustCallStatus) {
				C.uniffi_ldk_node_bindings_fn_free_channelconfig(pointer, status)
			}),
	}
...
func (_self *LdkNode) CloseChannel(channelId ChannelId, counterpartyNodeId PublicKey) error {
	...
	_, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_close_channel(
...
func (_self *LdkNode) Connect(nodeId PublicKey, address SocketAddress, persist bool) error {
	...
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_connect(
...
func (_self *LdkNode) ConnectOpenChannel(nodeId PublicKey, address SocketAddress, channelAmountSats uint64, pushToCounterpartyMsat *uint64, channelConfig **ChannelConfig, announceChannel bool) error {
	_pointer := _self.ffiObject.incrementPointer("*LdkNode")
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_connect_open_channel(
...
func (_self *LdkNode) Disconnect(nodeId PublicKey) error {
	...
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_disconnect(
...
func (_self *LdkNode) EventHandled() {
	...
	defer _self.ffiObject.decrementPointer()
	rustCall(func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_event_handled(
			_pointer, _uniffiStatus)
		return false
	})
}
...
func (_self *LdkNode) IsRunning() bool {
	...
	defer _self.ffiObject.decrementPointer()
	return FfiConverterBoolINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.int8_t {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_is_running(
			_pointer, _uniffiStatus)
	}))
}
...
func (_self *LdkNode) ListChannels() []ChannelDetails {
	...
	return FfiConverterSequenceTypeChannelDetailsINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_list_channels(
			_pointer, _uniffiStatus)
	}))
}
...
func (_self *LdkNode) ListPayments() []PaymentDetails {
	...
	return FfiConverterSequenceTypePaymentDetailsINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_list_payments(
			_pointer, _uniffiStatus)
	}))
}
...
func (_self *LdkNode) ListPeers() []PeerDetails {
	...
	return FfiConverterSequenceTypePeerDetailsINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_list_peers(
			_pointer, _uniffiStatus)
	}))
}
...
func (_self *LdkNode) ListeningAddresses() *[]SocketAddress {
	...
	return FfiConverterOptionalSequenceTypeSocketAddressINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_listening_addresses(
			_pointer, _uniffiStatus)
	}))
}
...
func (_self *LdkNode) NewOnchainAddress() (Address, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_new_onchain_address(
			_pointer, _uniffiStatus)
	})
	if _uniffiErr != nil {
...
func (_self *LdkNode) NextEvent() *Event {
	...
	return FfiConverterOptionalTypeEventINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_next_event(
			_pointer, _uniffiStatus)
	}))
}
...
func (_self *LdkNode) NodeId() PublicKey {
	...
	return FfiConverterTypePublicKeyINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_node_id(
			_pointer, _uniffiStatus)
	}))
}
...
func (_self *LdkNode) Payment(paymentHash PaymentHash) *PaymentDetails {
	...
	return FfiConverterOptionalTypePaymentDetailsINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_payment(
...
func (_self *LdkNode) ReceivePayment(amountMsat uint64, description string, expirySecs uint32) (Bolt11Invoice, error) {
	...
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_receive_payment(
...
func (_self *LdkNode) ReceiveVariableAmountPayment(description string, expirySecs uint32) (Bolt11Invoice, error) {
	...
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_receive_variable_amount_payment(
...
func (_self *LdkNode) RemovePayment(paymentHash PaymentHash) error {
	...
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_remove_payment(
			_pointer, FfiConverterTypePaymentHashINSTANCE.Lower(paymentHash), _uniffiStatus)
		return false
	})
	return _uniffiErr
...
func (_self *LdkNode) SendAllToOnchainAddress(address Address) (Txid, error) {
	...
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_send_all_to_onchain_address(
...
func (_self *LdkNode) SendPayment(invoice Bolt11Invoice) (PaymentHash, error) {
	...
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_send_payment(
...
func (_self *LdkNode) SendPaymentProbes(invoice Bolt11Invoice) error {
	...
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_send_payment_probes(
			_pointer, FfiConverterTypeBolt11InvoiceINSTANCE.Lower(invoice), _uniffiStatus)
		return false
	})
	return _uniffiErr
...
func (_self *LdkNode) SendPaymentProbesUsingAmount(invoice Bolt11Invoice, amountMsat uint64) error {
	...
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_send_payment_probes_using_amount(
...
func (_self *LdkNode) SendPaymentUsingAmount(invoice Bolt11Invoice, amountMsat uint64) (PaymentHash, error) {
	...
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_send_payment_using_amount(
			_pointer, FfiConverterTypeBolt11InvoiceINSTANCE.Lower(invoice), FfiConverterUint64INSTANCE.Lower(amountMsat), _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue PaymentHash
...
func (_self *LdkNode) SendSpontaneousPayment(amountMsat uint64, nodeId PublicKey) (PaymentHash, error) {
	...
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_send_spontaneous_payment(
...
func (_self *LdkNode) SendSpontaneousPaymentProbes(amountMsat uint64, nodeId PublicKey) error {
	...
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_send_spontaneous_payment_probes(
			_pointer, FfiConverterUint64INSTANCE.Lower(amountMsat), FfiConverterTypePublicKeyINSTANCE.Lower(nodeId), _uniffiStatus)
		return false
	})
	return _uniffiErr
...
func (_self *LdkNode) SendToOnchainAddress(address Address, amountMsat uint64) (Txid, error) {
	...
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_send_to_onchain_address(
...
func (_self *LdkNode) SignMessage(msg []uint8) (string, error) {
	...
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_sign_message(
...
func (_self *LdkNode) SpendableOnchainBalanceSats() (uint64, error) {
	...
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) C.uint64_t {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_spendable_onchain_balance_sats(
			_pointer, _uniffiStatus)
	})
	if _uniffiErr != nil {
...
func (_self *LdkNode) Start() error {
	...
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_start(
			_pointer, _uniffiStatus)
		return false
	})
	return _uniffiErr
...
func (_self *LdkNode) Stop() error {
	...
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_stop(
			_pointer, _uniffiStatus)
		return false
	})
	return _uniffiErr
...
func (_self *LdkNode) SyncWallets() error {
	...
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_sync_wallets(
			_pointer, _uniffiStatus)
		return false
	})
	return _uniffiErr
...
func (_self *LdkNode) TotalOnchainBalanceSats() (uint64, error) {
	...
	defer _self.ffiObject.decrementPointer()
	_uniffiRV, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) C.uint64_t {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_total_onchain_balance_sats(
			_pointer, _uniffiStatus)
	})
	if _uniffiErr != nil {
		var _uniffiDefaultValue uint64
...
func (_self *LdkNode) UpdateChannelConfig(channelId ChannelId, counterpartyNodeId PublicKey, channelConfig *ChannelConfig) error {
	...
	defer _self.ffiObject.decrementPointer()
	_, _uniffiErr := rustCallWithError(FfiConverterTypeNodeError{}, func(_uniffiStatus *C.RustCallStatus) bool {
		C.uniffi_ldk_node_bindings_fn_method_ldknode_update_channel_config(
...
func (_self *LdkNode) VerifySignature(msg []uint8, sig string, pkey PublicKey) bool {
	...
	defer _self.ffiObject.decrementPointer()
	return FfiConverterBoolINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) C.int8_t {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_verify_signature(
...
func (_self *LdkNode) WaitNextEvent() Event {
	...
	return FfiConverterTypeEventINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_method_ldknode_wait_next_event(
			_pointer, _uniffiStatus)
	}))
}
...
func (c FfiConverterLDKNode) Lift(pointer unsafe.Pointer) *LdkNode {
	result := &LdkNode{
		newFfiObject(
			pointer,
			func(pointer unsafe.Pointer, status *C.RustCallStatus) {
				C.uniffi_ldk_node_bindings_fn_free_ldknode(pointer, status)
			}),
	}
...
func DefaultConfig() Config {
	return FfiConverterTypeConfigINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_func_default_config(_uniffiStatus)
	}))
}
...
func GenerateEntropyMnemonic() Mnemonic {
	return FfiConverterTypeMnemonicINSTANCE.Lift(rustCall(func(_uniffiStatus *C.RustCallStatus) RustBufferI {
		return C.uniffi_ldk_node_bindings_fn_func_generate_entropy_mnemonic(_uniffiStatus)
	}))
}
