...
func (cs *CashuService) SendPaymentSync(ctx context.Context, invoice string, amount *uint64, isHoldInvoice bool) (response *lnclient.PayInvoiceResponse, err error) {
