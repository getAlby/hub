...
func (httpSvc *HttpService) RegisterSharedRoutes(e *echo.Echo) {
	...
	e.Use(middleware.SecureWithConfig(middleware.SecureConfig{
		...
		XFrameOptions:         "DENY",
		ContentSecurityPolicy: "default-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' https://uploads.getalby-assets.com https://getalby.com; connect-src 'self' https://api.getalby.com https://getalby.com https://zapplanner.albylabs.com wss://relay.getalby.com/v1; frame-src https://embed.bitrefill.com",
